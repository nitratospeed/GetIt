 ...
 */
public class CompraFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button b = v.findViewById(R.id.pagarBtn);
    ...
    public void ConfirmacionPago(){
        new AlertDialog.Builder(getContext())
                ...
                .setMessage("¿Está seguro de realizar el pago para este producto?")
