...
import com.example.getit.HistorialComprasFragment.OnListFragmentInteractionListener;
...
public class HistorialComprasAdapter extends RecyclerView.Adapter<HistorialComprasAdapter.ViewHolder> {
    ...
    public HistorialComprasAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_historialcompras, parent, false);
